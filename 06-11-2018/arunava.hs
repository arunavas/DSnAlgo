...
guardPos :: Cost -> [Position] -> [Position] -> Position -> [Position]
guardPos _ _ [] _ = []
...
nextMoves :: Cost -> [Position] -> [Position] -> [Position]
nextMoves _ _ [] = []
nextMoves cost ps pps@(curPos:_) = map (move curPos) [L .. D] >>= guardPos cost ps pps

shortestPath :: Cost -> [Position] -> [[Position]] -> [[Position]]
shortestPath _ _ [] = []
